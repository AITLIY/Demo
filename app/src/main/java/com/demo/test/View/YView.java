...
public class YView extends View {
    ...
    private void drawNomal(Canvas canvas){
        ...
        RectF rect = new RectF(10, 700, 200, 800);
        // 画圆角矩形
        canvas.drawRoundRect(rect, 30, 30, mPaint);
        // 画圆角矩形2
        canvas.drawRoundRect(260, 700, 360, 800, 30, 30, mPaint);

        //绘制圆弧 绘制扇形
        mPaint.setStyle(Paint.Style.FILL);
        mPaint.setColor(Color.RED);

        RectF re1 = new RectF(600, 500, 800, 700);
        canvas.drawArc(re1, 10, 270, false, mPaint);
        RectF re2 = new RectF( 810, 500, 1010, 700);
        ...
        canvas.drawTextOnPath("0123456789-0123456789-0123456789-0123456789", path, -20, -20, mPaint);
        ...
        path1.lineTo(230, 350);
        path1.lineTo(170, 350);
        path1.close();
